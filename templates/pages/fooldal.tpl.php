<h2>F1 Rajongói Oldal</h2>
<p>Üdvözöljük a weboldalon! Itt mindent megtalál a Forma-1 világáról.</p>

<div class="media-container">
    <h3>Videók</h3>
    <!-- Saját videó, max 5 másodperc[cite: 1] -->
    <video width="320" height="240" controls>
        <source src="video/sajat_video.mp4" type="video/mp4">
    </video>

    <!-- YouTube videó[cite: 1] -->
    <iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ" frameborder="0" allowfullscreen></iframe>
</div>

<div class="map-container">
    <h3>Irodánk helyszíne</h3>
    <!-- Google térkép[cite: 1] -->
